...
@Component({
  selector: 'app-reportar-coordinacion',
  templateUrl: './reportar-coordinacion.component.html',
  styleUrls: ['./reportar-coordinacion.component.css']
})
export class ReportarCoordinacionComponent {
